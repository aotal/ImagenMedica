...
## Bases de Datos Relacionales: Relational DB Management System (RDBMS)
...
- **Lenguaje:** Varía según el tipo. Algunas usan lenguajes tipo SQL, otras APIs(Application Programming Interface).
- **Ventajas:**
...
- **Desventajas:**
    - Generalmente, menor soporte para transacciones ACID completas (En general las documentales).
...
3. Extracción de Características
    ...
    - Algoritmos extraen *miles* de características.
